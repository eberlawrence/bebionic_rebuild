...
#define S2 PORTBbits.RB9
#define S3 PORTBbits.RB10
...
{
    RPINR1bits.INT2R = 9; // Define the pin number, according to RPx
    INTCON2bits.INT2EP = 0; // External interrupt edge detect polarity
    IEC1bits.INT2IE = 1; // 
    IPC7bits.INT2IP = 1; 
}
...
{
    PWM(1000, "forward"); // The range is 0 to 1841 (duty cicle);
    __delay_ms(30);
    IFS1bits.INT1IF = 0;
}
...
{
    PWM(1000, "backward"); // The range is 0 to 1841 (duty cicle);
    __delay_ms(30);
    IFS1bits.INT2IF = 0;
}
